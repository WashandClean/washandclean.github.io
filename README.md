...
├── assets/
│   ├── before.jpg    # Imagem “Antes” (interior sujo) – podes substituir por foto real
│   ├── after.jpg     # Imagem “Depois” (interior limpo) – podes substituir por foto real
...
### Preços
Incluímos preços indicativos para cada serviço, baseados em valores praticados por empresas de lavagem e detalhamento automóvel em Portugal【333192737567837†L36-L59】【321569440428852†L12-L19】. Ajuste estes valores conforme as tarifas da Wash&Clean:

- **Lavagem Exterior:** €20
- **Lavagem Interior:** €30
- **Detalhamento Completo:** €90
- **Extras:** desde €10 (consoante o serviço extra escolhido)

Pode editar estes valores no ficheiro `index.html` procurando pelas etiquetas `<p class="price">` em cada cartão de serviço.
